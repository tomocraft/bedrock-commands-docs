...
- [/aimassist](#cmd-aimassist)
- [/allowlist](#cmd-allowlist)
- [/camera](#cmd-camera)
- [/camerashake](#cmd-camerashake)
- [/changesetting](#cmd-changesetting)
- [/clear](#cmd-clear)
- [/clearspawnpoint](#cmd-clearspawnpoint)
- [/clone](#cmd-clone)
- [/controlscheme](#cmd-controlscheme)
- [/damage](#cmd-damage)
- [/daylock](#cmd-daylock)
- [/deop](#cmd-deop)
- [/dialogue](#cmd-dialogue)
...
- [/gametest](#cmd-gametest)
- [/give](#cmd-give)
- [/hud](#cmd-hud)
- [/inputpermission](#cmd-inputpermission)
- [/kick](#cmd-kick)
- [/kill](#cmd-kill)
- [/list](#cmd-list)
- [/locate](#cmd-locate)
- [/loot](#cmd-loot)
- [/me](#cmd-me)
- [/mobevent](#cmd-mobevent)
- [/music](#cmd-music)
- [/op](#cmd-op)
- [/packstack](#cmd-packstack)
- [/particle](#cmd-particle)
- [/permission](#cmd-permission)
- [/place](#cmd-place)
- [/playanimation](#cmd-playanimation)
- [/playsound](#cmd-playsound)
- [/recipe](#cmd-recipe)
- [/reload](#cmd-reload)
- [/reloadconfig](#cmd-reloadconfig)
- [/reloadpacketlimitconfig](#cmd-reloadpacketlimitconfig)
- [/replaceitem](#cmd-replaceitem)
- [/ride](#cmd-ride)
- [/save](#cmd-save)
- [/say](#cmd-say)
- [/schedule](#cmd-schedule)
- [/scoreboard](#cmd-scoreboard)
- [/sendshowstoreoffer](#cmd-sendshowstoreoffer)
- [/setblock](#cmd-setblock)
- [/setmaxplayers](#cmd-setmaxplayers)
- [/setworldspawn](#cmd-setworldspawn)
- [/spawnpoint](#cmd-spawnpoint)
- [/spreadplayers](#cmd-spreadplayers)
- [/stop](#cmd-stop)
- [/stopsound](#cmd-stopsound)
...
- [/tellraw](#cmd-tellraw)
- [/testfor](#cmd-testfor)
- [/testforblock](#cmd-testforblock)
- [/testforblocks](#cmd-testforblocks)
- [/tickingarea](#cmd-tickingarea)
- [/time](#cmd-time)
- [/title](#cmd-title)
- [/titleraw](#cmd-titleraw)
- [/toggledownfall](#cmd-toggledownfall)
...
- [/script](#cmd-script)
- [/scriptevent](#cmd-scriptevent)
- [/wsserver](#cmd-wsserver)

### Education Edition-only Commands

- [/ability](#cmd-ability)
- [/immutableworld](#cmd-immutableworld)
- [/worldbuilder](#cmd-worldbuilder)
